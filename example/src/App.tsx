...
export default function App() {
  ...
  const buttons = (
    <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
      <Button
        title={`change to ${numColumns + 1} columns`}
        onPress={() => {
      ...
      />
      <Button
        title={`seperator (${separator ? 'true' : 'false'})`}
        onPress={() => {
      ...
      />
      <Button
        title={`inverted (${inverted ? 'true' : 'false'})`}
        onPress={() => {
      ...
      />
      <Button
        title={`itemlayout (${itemLayout ? 'true' : 'false'})`}
        onPress={() => {
          setItemLayout((prev) => !prev);
          setMounted(false);
        }}
      />
      <Button
        title={`stickyHeader (${stickyHeader ? 'true' : 'false'})`}
        onPress={() => {
  ...
  return (
    ...
    >
      {mounted ? (
        <RidgeList
          stickyHeaderIndices={stickyHeader ? [2] : undefined}
          data={data}
          numColumns={numColumns}
          onEndReached={() => {
            console.log('onEndReached');
            timesAdded.current += 1;
            setData(
              inverted
                ? [
                    ...initialData.map((c) => ({
                      ...c,
                      id: timesAdded.current * c.id * 10,
                    })),
                    ...data,
                  ]
                : [
          ...
          ListHeaderComponent={(props) => {
            console.log('ListHeaderComponent', { props });
            return <View style={{ flexDirection: 'row' }}>{buttons}</View>;
          }}
          ListFooterComponent={(props) => {
            console.log('ListFooterComponent', { props });
            return <View style={{ flexDirection: 'row' }}>{buttons}</View>;
          }}
          ...
          getItemLayout={itemLayout ? getDefaultItemLayout : undefined}
          style={styles.root}
          inverted={inverted}
        />
      ) : null}
